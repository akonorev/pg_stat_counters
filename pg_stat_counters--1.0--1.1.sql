/* pg_stat_counters/pg_stat_counters--1.0--1.1.sql */

-- complain if script is sourced in psql, rather than via ALTER EXTENSION
\echo Use "ALTER EXTENSION pg_stat_counters UPDATE TO '1.1'" to load this file. \quit
...
ALTER EXTENSION pg_stat_counters DROP VIEW dba_stat_counters;
ALTER EXTENSION pg_stat_counters DROP VIEW pg_stat_counters;
ALTER EXTENSION pg_stat_counters DROP VIEW pg_stat_counters_all;
ALTER EXTENSION pg_stat_counters DROP FUNCTION pg_stat_counters();
ALTER EXTENSION pg_stat_counters DROP FUNCTION pg_stat_counters_all();

/* Then we can drop them */
DROP VIEW dba_stat_counters;
DROP VIEW pg_stat_counters;
DROP VIEW pg_stat_counters_all;
DROP FUNCTION pg_stat_counters();
DROP FUNCTION pg_stat_counters_all();
